...
Design= Design[Design[,3] == 0, ]

#baseline 975 quantile
baseline_mse_total = readRDS("output/mse_baseline_975_10.rds")
...
for(i in 1:nrow(Design)){
  for(r in 1:nreps){
    ...
    params = c(Design[i,1],Design[i,2],ad_name[Design[i,4]], 10, "Urnings2",TRUE ,dist_type)
...
saveRDS(results, "output/ht_central_10.rds")
